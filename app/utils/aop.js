...
module.exports = {
    ...
    execute(method, config, apiParams) {
        return new Promise((resolve, reject) => {
            ...
            var signContent = signHelper.getSignContent(sysParams, {
            ...
            request.post(requestUrl, {
                ...
                return reject({
                    message: `验证支付宝签名时获取[${rootNodeName}]字段失败`,
                    info: jsonBody
                });
            });
        })
